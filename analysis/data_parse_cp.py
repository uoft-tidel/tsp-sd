...
for instance in [f for f in os.listdir(results_folder) if "cp" in f]:
    ...
    for l in f:
        if "===INSTANCE" in l:
            j_val += 1
            i_name = l.split(" ")[1][:-6]
            instances[j_val] = {"instance":"","algorithm":"","beam_size":{"size":[],"expanded":[],"time":[]},"dual":{"bound":[],"expanded":[],"time":[]},"primal":{"bound":[],"expanded":[],"time":[]},"hit_time_limit":False,"best_dual":0,"best_primal":0,"expanded":0,"generated":0,"infeasible":True,"optimal":False,"time":0,"transitions":[],"memory":0,"nodes":0}
