...
## 27000 ht
parallel -j 2 "python3 run_models.py 1800 {1} {2} | tee /gpfs/fs0/scratch/b/beck/pekardan/results/8_threads_2_task_run_{1}_{2}.txt" ::: DIDP-add ::: eil101-27.5 gr202-67.3